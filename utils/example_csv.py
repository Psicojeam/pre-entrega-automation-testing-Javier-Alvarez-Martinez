...
def get_login_csv(csv_file = "data_login.csv"):
    ...
    with open(csv_file, newline="") as h:
        ...
        # {username: 'asdasd, password: 'asdasd', login_example: 'true'} 

        for i in read:
            username = i ['username']
            password = i ['password']
            login_example = i ['login_example'].lower() == "true" #aqui lo estoy obligando a que sea un booleano
